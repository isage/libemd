...
typedef uint64_t _elf_uint64_t;

typedef struct Cpp_token Cpp_token, *PCpp_token;
...
typedef struct Cpp_token_buffer Cpp_token_buffer, *PCpp_token_buffer;

struct Cpp_token_buffer
{
